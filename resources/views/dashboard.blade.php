        ...
        <div class="py-0.5">
            <div class="flex flex-wrap justify-center gap-1.5 sm:gap-2 mt-2">
                ...
                <a href="{{ route('main') }}" title="Analytics and insights"
                    class="py-1.5 px-2.5 flex flex-col items-center text-sm text-gray-800 bg-gray-100 rounded-lg
          hover:bg-gray-200 hover:text-cyan-700 transition duration-200">
